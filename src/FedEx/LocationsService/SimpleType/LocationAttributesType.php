...
class LocationAttributesType extends AbstractSimpleType
{
    ...
    const _EXPRESS_FREIGHT_DROPOFFS = 'EXPRESS_FREIGHT_DROPOFFS';
    const _EXPRESS_PARCEL_DROPOFFS = 'EXPRESS_PARCEL_DROPOFFS';
    const _FEDEX_FREIGHT_DROPOFFS = 'FEDEX_FREIGHT_DROPOFFS';
    const _GROUND_DROPOFFS = 'GROUND_DROPOFFS';
    const _GROUND_HOME_DELIVERY_DROPOFFS = 'GROUND_HOME_DELIVERY_DROPOFFS';
    ...
    const _SAME_DAY_CITY_DROPOFFS = 'SAME_DAY_CITY_DROPOFFS';
    const _SAME_DAY_DROPOFFS = 'SAME_DAY_DROPOFFS';
    const _SATURDAY_DROPOFFS = 'SATURDAY_DROPOFFS';
    const _SATURDAY_EXPRESS_HOLD_AT_LOCATION = 'SATURDAY_EXPRESS_HOLD_AT_LOCATION';
    ...
    const _VIDEO_CONFERENCING = 'VIDEO_CONFERENCING';
    const _WEEKDAY_EXPRESS_HOLD_AT_LOCATION = 'WEEKDAY_EXPRESS_HOLD_AT_LOCATION';
    const _WEEKDAY_GROUND_HOLD_AT_LOCATION = 'WEEKDAY_GROUND_HOLD_AT_LOCATION';
}
