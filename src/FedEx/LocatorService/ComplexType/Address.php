    ...
    extends AbstractComplexType
{
    ...
    /**
     * Returns Combination of number, street name, etc. Empty lines should not be included.
     *
     * @return string[]
     */
    ...
    /**
     * Returns Identification of a country. Defaults to "US". Valid values: US - United States, CA - Canada.
     *
     * @return string
     */
